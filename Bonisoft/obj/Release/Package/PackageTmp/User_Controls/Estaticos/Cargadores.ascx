<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cargadores.ascx.cs" Inherits="Bonisoft.User_Controls.Estaticos.Cargadores" %>
...
<asp:GridView ID="gridCargadores" runat="server" ClientIDMode="Static" HorizontalAlign="Center" AutoGenerateColumns="False" ShowFooter="True" 
    ...
    <Columns>
       <asp:BoundField DataField="Cargador_ID" HeaderText="ID" HtmlEncode="false" ReadOnly="true"/>
