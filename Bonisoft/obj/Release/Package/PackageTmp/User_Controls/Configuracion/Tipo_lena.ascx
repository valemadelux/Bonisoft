<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tipo_lena.ascx.cs" Inherits="Bonisoft.User_Controls.Configuracion.Tipo_lena" %>
...
<asp:GridView ID="gridTipos" runat="server" ClientIDMode="Static" HorizontalAlign="Center" AutoGenerateColumns="False" ShowFooter="True" 
    ...
    <Columns>
        <asp:BoundField DataField="Lena_tipo_ID" HeaderText="ID" HtmlEncode="false" ReadOnly="true"/>
