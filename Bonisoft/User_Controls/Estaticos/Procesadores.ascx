<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Procesadores.ascx.cs" Inherits="Bonisoft.User_Controls.Estaticos.Procesadores" %>
...
<asp:GridView ID="gridProcesadores" runat="server" ClientIDMode="Static" HorizontalAlign="Center" AutoGenerateColumns="False" ShowFooter="True" 
    ...
    <Columns>
        <asp:BoundField DataField="Procesador_ID" HeaderText="ID" HtmlEncode="false" ReadOnly="true"/>
