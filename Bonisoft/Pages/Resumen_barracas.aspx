<%@ Page Title="Resumen de Cl. Barracas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Resumen_barracas.aspx.cs" Inherits="Bonisoft.Pages.Resumen_barracas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <!-- PAGE CSS -->
    <link rel="stylesheet" href="/assets/dist/css/pages/Resumen_barracas.css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubbodyContent" runat="server">
    ...
    <script type="text/javascript" src="/assets/dist/js/pages/Resumen_barracas.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-default">
        <div class="box-header with-border" style="padding-bottom: 0;">
            ...
            <div class="row">
                <div class="col-md-9">
                    <h1 style="font-size: 24px;">Resumen de Clientes barracas</h1>
                </div>
            </div>
